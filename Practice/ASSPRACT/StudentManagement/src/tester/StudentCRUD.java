...
public class StudentCRUD {
    //private static final String JDBC_URL = "jdbc:mysql://localhost:3306/stud";  /*"jdbc:mysql://mysqldb:3306/students";*/
    private static final String JDBC_URL = "jdbc:mysql://mysqldb:3306/stud";
    ...
    public static void main(String[] args) {
        try (Connection conn = DriverManager.getConnection(JDBC_URL, USERNAME, PASSWORD)) {
            createTable(conn);
            insertStudent(conn, 106, "John Doe", "Class X", "A");
            System.out.println("One record inserted");
            insertStudent(conn, 107, "Jane Smith", "Class XI", "B");
            System.out.println("One record inserted");

            Student studentToUpdate = new Student(106, "John Doe Updated", "Class X", "A");
            ...
            System.out.println("All students desplayed");
